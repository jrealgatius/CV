...
if(PDF_EXPORT){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/jrealgatius/CV/blob/master/JReal_CV.pdf)")
}
...
- <i class="fa fa-github"></i>  [jrealgatius](https://github.com/jrealgatius)
...
text_adreca_orcid<-paste0("I have worked in a variety of papers ranging from data analyist to researcher to data scientist.The rest of the papers can it see [here]",adreca_orcid_jordi) 
